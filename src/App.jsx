...
function App() {
  ...
  switch (gameState) {
    case "start":
      return <StartScreen start={() => setTimeout(setGameState("select"), 800)} ret={ret} setRet={setRet}></StartScreen>;
    case "select":
      return (
        <SelectScreen
    ...
    case "stats":
      return <StatsScreen winner={winner} end={() => {setGameState("start"); setDifficulty(null)}} gameMode={gameMode} setRet={setRet} />
    default:
